            ...
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
              ...
              <div>
                <div className="inline-flex gap-x-2">
                  <div className="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-300 shadow-sm text-sm dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                    <svg
                      className="w-3 h-3"
                      width="16"
                      height="16"
