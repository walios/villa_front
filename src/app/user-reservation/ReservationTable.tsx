...
function ReservationTable(props:ReservationTableProps) {
  const reservationData = props.reservationData;
console.log("🚀 ~ file: ReservationTable.tsx:22 ~ reservationData:", reservationData)
          ...
          <div className="bg-white-50 border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              {reservationData.map(reservation => (
                  ...
                  >
                    <ReservationModal reservationData={reservation}/>
                    ...
                    <td className="h-px w-px whitespace-nowrap">
                      ...
                      >
                        <div className="px-6 py-1.5">
                          <div className="py-1 px-2 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white-50 text-gray-700 shadow-sm align-middle hover:bg-gray-50 text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white-50">
                            <svg
                              className="w-4 h-4"
                              xmlns="http://www.w3.org/2000/svg"
                              width="16"
